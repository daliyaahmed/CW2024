...
/**
 * The {@code LevelFourBanner} class is responsible for displaying a banner
 * for Level Four at the start of the level. It includes animations for smooth appearance
 * and removal of the banner.
 */
public class LevelFourBanner {

    /** The ImageView displaying the banner. */
    private final ImageView banner;

    /**
     * Constructs a {@code LevelFourBanner} object with the given screen dimensions.
     ...
     */
    public LevelFourBanner(double screenWidth, double screenHeight) {
        Image levelOneGif = new Image(getClass().getResource("/com/example/demo/images/Lvl4banner.gif").toExternalForm());
