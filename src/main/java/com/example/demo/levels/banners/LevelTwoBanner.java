...
/**
 * The {@code LevelTwoBanner} class is responsible for displaying a banner
 * at the start of Level Two. It includes animations for smooth appearance
...
public class LevelTwoBanner {
    ...
    /**
     * Constructs a {@code LevelTwoBanner} object with the given screen dimensions.
