...
public class PauseMenu {
    ...
    public PauseMenu(Group root, Timeline timeline, double screenWidth, double screenHeight,
    ...
    private void showPauseWindow(Button pauseButton) {
        ...
        borderBox.setStyle("-fx-background-color: rgba(0, 0, 0, 0.3); -fx-border-color: #00FFFF; -fx-border-width: 5px; -fx-border-radius: 20; -fx-background-radius: 20;");
        ...
        pauseLabel.setStyle(
                "-fx-font-family: 'Lucida Console';" + // Similar to Sky Battle's bold font
                        "-fx-font-size: 30px;" +       // Font size
                        "-fx-text-fill: linear-gradient(#8B4513, #FFD700);" + // Gradient from brown to gold
    ...
    private void resumeGameWithCountdown(Button pauseButton) {
        ...
        Timeline countdownTimeline = new Timeline(
                new KeyFrame(Duration.seconds(1), e -> {
                    ...
                    neonShadow.setColor(Color.LIME);
                    innerGlow.setColor(Color.LIME);
                    countdownLabel.setEffect(neonShadow);
                    countdownLabel.setEffect(innerGlow);
                }),
                new KeyFrame(Duration.seconds(2), e -> {
                    countdownLabel.setText("1");
                    neonShadow.setColor(Color.MAGENTA);
                    innerGlow.setColor(Color.MAGENTA);
                    countdownLabel.setEffect(neonShadow);
                    countdownLabel.setEffect(innerGlow);
                }),
